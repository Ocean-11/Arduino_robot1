...
*******************************************************************************/
bool is_feeder_active = true;      // Feeder starts inactive
...
bool is_feeder_enabled = false;      // Feeder is enabled 
...
*******************************************************************************/
bool right_forward_en = true;
bool right_backward_en = false;
bool left_forward_en = true;
bool left_backward_en = false;
...
bool right_IR = false;//right sensor find cliff
bool left_IR = false; //left sensor find cliff
